...
public class StringConcept {
	...
	public static void main(String[] args) {
		System.out.println("Main Method String length is: " + args.length);
		...
		String item = "Apple, Mango, Banana, Papaya, Pomegranate";
		String allItem[] = item.split(", ");
		for (String i : allItem) {
			System.out.println(i);
		}
		System.out.println(item.contains("Mango"));// true
		System.out.println(item.toUpperCase());
		System.out.println(item.toLowerCase());
		System.out.println(s7.trim());// remove spaces
	}
